using static mistletoe.Mistletoe;
...
#pragma warning disable CA1822  // Preferable to keep the public interface non-static, irrespective of the implementation, in this context.
...
namespace Assignment2
{
    public class Scenario
    {
        ...
        {
            var m = MT(V("nextMessage").Call());
            return (m.Count == 0) ? null : (string)m[0];
        }
